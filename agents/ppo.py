...
from agents.base_v0 import BaseAlgoV0


class PPOAlgo(BaseAlgoV0):
    ...
    def __init__(self, cfg, envs, acmodel, agent_data, **kwargs):
        ...
        super().__init__(envs, acmodel, num_frames_per_proc, discount, gae_lambda, entropy_coef,
        ...
        self.optimizer = getattr(torch.optim, optimizer)(self.acmodel.parameters(),
                                                         **optimizer_args)
